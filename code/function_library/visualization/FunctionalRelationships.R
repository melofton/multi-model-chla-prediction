...
par(cex.lab = 1.5, mgp = c(2.7,1,0))
curve(f6(x, theta = g1$theta, tp = tp, kTn = g1_Tparms$kTn, aTn = g1_Tparms$aTn, bTn = g1_Tparms$bTn, T_std = g1$T_std, T_opt = g1$T_opt, T_max = g1$T_max),from=0, to=40, n = 300, ylab='fT',xlab = "Water temperature (ºC)", yaxt = "n")
axis(2, las = 2)
curve(f6(x, theta = g2$theta, tp = tp, kTn = g2_Tparms$kTn, aTn = g2_Tparms$aTn, bTn = g2_Tparms$bTn, T_std = g2$T_std, T_opt = g2$T_opt, T_max = g2$T_max),from=0, to=40, n = 300, add = TRUE, lty = 2)

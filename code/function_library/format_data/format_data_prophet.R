...
#'Function to format data for Prophet model for chla from 2018-2022
...
format_data_Prophet <- function(filepath_chemistry = "./data/data_raw/chemistry_2013_2023.csv",

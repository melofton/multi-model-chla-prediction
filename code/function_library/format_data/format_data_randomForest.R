#Format data for random forest model for chl-a
#Author: Mary Lofton
#Date last updated: 08OCT24
...
format_data_randomForest <- function(filepath_chemistry = "./data/data_raw/chemistry_2013_2023.csv",
